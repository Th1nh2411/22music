...
<body>
 	<div>${message}</div>
	<form:form action = "insertnhac.htm" modelAttribute ="baihat"  enctype = "multipart/form-data" method = "post">
	...
	<label>Quốc Gia</label>
		<select id = "quocgia" name ="quocgia" value = "${baihat.quocgia}">
				...
				<option value ="ChauA">Nhạc Châu Á</option>
				<option value ="MyLatin">Mỹ Latin</option>
				<option value ="US-UK">Nhạc US-UK</option>
				<option value ="NhacHoa">Nhạc Hoa</option>
				<option value ="Korean">Nhạc Hàn</option>
				<option value ="Khac">Thể Loại Khác</option>
	...
	<div>
		...
		<input type = "file" name = "fileimagecore" value ="D:/LapTrinh/Web/Web_NgheNhac/WebContent/${baihat.imagecore}" >
	</div>
	<div>
		<label>File Âm Thanh</label>
		<input type = "file" name = "fileaudio" value = "D:/LapTrinh/Web/Web_NgheNhac/WebContent/${baihat.audio}">
	</div>
	<div>
	...
	<div>
		<button class="btn btn-default"><a href="insertnhac.htm">Nhập lại</a></button>
