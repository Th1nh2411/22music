...
<body>
	...
	<br>
	<br>
	<form action="timkiemlistnhac.htm">
	...
	<table class="table table-hover">
		<tr>
			...
			<th>Quốc Gia</th>
			<th>Ca Sĩ</th>
			<th><a href="insertnhac.htm">Insert</a></th>
			<th></th>
		</tr>
		<c:forEach var="u" items="${baihat}">
			<tr>
				<td><img alt="" src="${u.imagecore}"></td>
				<td>${u.ten}</td>
				...
				<td>${u.quocgia}</td>
				<td>${u.casi}</td>
				<td><a href="deletenhac.htm?id=${u.id}">Delete</a></td>
				<td><a href="updatenhac.htm?id=${u.id}">update</a></td>
			</tr>
		</c:forEach>
	</table>
