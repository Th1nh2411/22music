	...
	<section
		...
		<div class="tag-container container ">
				...
				<div class="col-12 col-md-12 col-lg-12">
					<div class="featured-artist-content">
						...
						<div class="section-heading white ">
							<h3>Kết quả tìm kiếm cho  <span>${kiemtra}</span></h3>
			...
			<div class="list-song row">
				...
				<c:forEach var="searchSongs" items="${searchSongs}">
					<!-- Single Album Area -->
					<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-30 wow fadeInUp" data-wow-delay="100ms">
					
						<a href="Nhac/${searchSongs.id}/0.htm" class="single-album-area " >
							<div class="album-thumb" style="background: url(${searchSongs.image}) center /cover no-repeat"></div>
						...
						<div class="album-info white">
							...
							<h5>${searchSongs.songName}</h5>
							<p>${searchSongs.performer}</p>
						</div>
