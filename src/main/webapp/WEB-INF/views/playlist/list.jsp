...
<body>
	...
	<div>${message}</div>
	<div>
		<form action ="createplaylist.htm">
		<div>
			<label>Tên PlayList</label>
			<input type = "text" name = "tenplaylist" value = "Unknown">
			<button>Tạo</button>
		</div>
		</form>
	</div>
	<table class="table table-hover">
		...
		<c:forEach var="u" items="${playlist}">
			<tr>
				
				<td>${u.playlistname}</td>
				<td><a href="listplaylist.htm?id=${u.id}">Xem</a></td>
				<td><a href = "insertplaylist.htm?id=${u.id}">Chọn</a><td>
				<td><a href = "deleteplaylist.htm?id=${u.id}">Xóa</a><td>
			</tr>
		</c:forEach>
	</table>
