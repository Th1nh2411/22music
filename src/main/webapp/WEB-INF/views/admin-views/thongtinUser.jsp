            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="in">
                        <!-- User Profile-->                        
                        <li class="sidebar-item selected"> <a  class="sidebar-link waves-effect waves-dark sidebar-link"  href="admin/trangchu.htm" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span class="hide-menu">Bài hát</span></a></li>                                               
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="admin/thongtinUser.htm" aria-expanded="false"><i class="mdi me-2 mdi-account-settings-variant"></i><span class="hide-menu">Tài khoản</span></a>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Thông tin người dùng</h3>
...
">
    <h4 class="card-title">Thông tin</h4>
						...
						<c:url value="admin/thongtinUser.htm" var="pagedLink">
...
<i class="ti-exchange-vertical"></i></th>
                                                ...
                                                <th class="border-top-0">Giới tính<i class="ti-exchange-vertical" style="
    margin-left: 6px;
"></i></th>
 <th class="border-top-0">Email<i class="ti-exchange-vertical" style="
    margin-left: 6px;
"></i></th>
...
<c:forEach var="u" items="${pagedListHolder.pageList}">					
							<tr>
                                                <td>${u.id}</td>
                                                <td>${u.name}</td>
                                                <td><c:if test="${u.gender == 1}">Nữ</c:if> <c:if
								test="${u.gender == 0}">Nam</c:if></td>
                                                <td>${u.mail}</td>
                                            <td style="
    text-align: center;
">
