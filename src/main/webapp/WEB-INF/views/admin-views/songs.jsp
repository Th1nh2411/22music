            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="in">
                        <!-- User Profile-->                        
                        <li class="sidebar-item selected"> <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="file:///D:/Download/Compressed/material-pro-lite-master/html/table-basic.html" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span class="hide-menu">Bài hát</span></a></li>                                               
...
<a type="button" class="btn btn-secondary" href="admin/xoasong/${u.id}.htm">Xóa</a></td></tr>
						</c:forEach>			                                                                                                                           
                                        </tbody>
                                    </table>
                                </div>
